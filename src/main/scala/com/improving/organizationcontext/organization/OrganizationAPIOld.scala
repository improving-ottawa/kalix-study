...
//        case ApiStatus.DRAFT      => OrganizationStatus.DRAFT
//        case ApiStatus.ACTIVE     => OrganizationStatus.ACTIVE
//        case ApiStatus.SUSPENDED  => OrganizationStatus.SUSPENDED
//        case ApiStatus.TERMINATED => OrganizationStatus.TERMINATED
