...
@SerialVersionUID(0L)
final case class TenantActivated(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[TenantActivated] {
    @transient
    ...
    def clearTenantId: TenantActivated = copy(tenantId = _root_.scala.None)
    def withTenantId(__v: com.improving.TenantId): TenantActivated = copy(tenantId = Option(__v))
    def withName(__v: _root_.scala.Predef.String): TenantActivated = copy(name = __v)
    def getMeta: com.improving.tenantcontext.MetaInfo = meta.getOrElse(com.improving.tenantcontext.MetaInfo.defaultInstance)
    def clearMeta: TenantActivated = copy(meta = _root_.scala.None)
    def withMeta(__v: com.improving.tenantcontext.MetaInfo): TenantActivated = copy(meta = Option(__v))
    ...
    def companion: com.improving.tenantcontext.TenantActivated.type = com.improving.tenantcontext.TenantActivated
    // @@protoc_insertion_point(GeneratedMessage[com.improving.tenantcontext.TenantActivated])
}

object TenantActivated extends scalapb.GeneratedMessageCompanion[com.improving.tenantcontext.TenantActivated] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.tenantcontext.TenantActivated] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.tenantcontext.TenantActivated = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.tenantcontext.TenantActivated] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TenantContextDomainProto.javaDescriptor.getMessageTypes().get(7)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TenantContextDomainProto.scalaDescriptor.messages(7)
  ...
  lazy val defaultInstance = com.improving.tenantcontext.TenantActivated(
    tenantId = _root_.scala.None,
    name = "",
    meta = _root_.scala.None
  )
  implicit class TenantActivatedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.tenantcontext.TenantActivated]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.tenantcontext.TenantActivated](_l) {
  ...
  ): _root_.com.improving.tenantcontext.TenantActivated = _root_.com.improving.tenantcontext.TenantActivated(
    tenantId,
    name,
    meta
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.tenantcontext.TenantActivated])
}
