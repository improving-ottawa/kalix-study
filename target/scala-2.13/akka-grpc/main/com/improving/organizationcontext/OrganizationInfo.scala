...
final case class OrganizationInfo(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[OrganizationInfo] {
    @transient
    ...
    def clearOrgId: OrganizationInfo = copy(orgId = _root_.scala.None)
    def withOrgId(__v: com.improving.OrganizationId): OrganizationInfo = copy(orgId = Option(__v))
    def getInfo: com.improving.organizationcontext.Info = info.getOrElse(com.improving.organizationcontext.Info.defaultInstance)
    def clearInfo: OrganizationInfo = copy(info = _root_.scala.None)
    def withInfo(__v: com.improving.organizationcontext.Info): OrganizationInfo = copy(info = Option(__v))
    ...
    def companion: com.improving.organizationcontext.OrganizationInfo.type = com.improving.organizationcontext.OrganizationInfo
    // @@protoc_insertion_point(GeneratedMessage[com.improving.organizationcontext.OrganizationInfo])
}

object OrganizationInfo extends scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.organizationcontext.OrganizationInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.organizationcontext.OrganizationInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = OrganizationContextDomainProto.javaDescriptor.getMessageTypes().get(17)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = OrganizationContextDomainProto.scalaDescriptor.messages(17)
  ...
  lazy val defaultInstance = com.improving.organizationcontext.OrganizationInfo(
    orgId = _root_.scala.None,
    info = _root_.scala.None
  )
  implicit class OrganizationInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.organizationcontext.OrganizationInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.organizationcontext.OrganizationInfo](_l) {
  ...
  ): _root_.com.improving.organizationcontext.OrganizationInfo = _root_.com.improving.organizationcontext.OrganizationInfo(
    orgId,
    info
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfo])
}
