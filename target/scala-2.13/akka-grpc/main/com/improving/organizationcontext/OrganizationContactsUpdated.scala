...
@SerialVersionUID(0L)
final case class OrganizationContactsUpdated(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[OrganizationContactsUpdated] {
    @transient
    ...
    def clearOrgId: OrganizationContactsUpdated = copy(orgId = _root_.scala.None)
    def withOrgId(__v: com.improving.OrganizationId): OrganizationContactsUpdated = copy(orgId = Option(__v))
    def clearContacts = copy(contacts = _root_.scala.Seq.empty)
    def addContacts(__vs: com.improving.organizationcontext.Contacts *): OrganizationContactsUpdated = addAllContacts(__vs)
    def addAllContacts(__vs: Iterable[com.improving.organizationcontext.Contacts]): OrganizationContactsUpdated = copy(contacts = contacts ++ __vs)
    def withContacts(__v: _root_.scala.Seq[com.improving.organizationcontext.Contacts]): OrganizationContactsUpdated = copy(contacts = __v)
    ...
    def clearMeta: OrganizationContactsUpdated = copy(meta = _root_.scala.None)
    def withMeta(__v: com.improving.organizationcontext.MetaInfo): OrganizationContactsUpdated = copy(meta = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PRepeated(contacts.iterator.map(_.toPMessage).toVector)
        case 3 => meta.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.improving.organizationcontext.OrganizationContactsUpdated.type = com.improving.organizationcontext.OrganizationContactsUpdated
    // @@protoc_insertion_point(GeneratedMessage[com.improving.organizationcontext.OrganizationContactsUpdated])
}

object OrganizationContactsUpdated extends scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationContactsUpdated] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationContactsUpdated] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.organizationcontext.OrganizationContactsUpdated = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.organizationcontext.OrganizationContactsUpdated] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.improving.organizationcontext.OrganizationContactsUpdated(
        ...
        contacts = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[com.improving.organizationcontext.Contacts]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = OrganizationContextDomainProto.javaDescriptor.getMessageTypes().get(15)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = OrganizationContextDomainProto.scalaDescriptor.messages(15)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = com.improving.OrganizationId
      case 2 => __out = com.improving.organizationcontext.Contacts
  ...
  lazy val defaultInstance = com.improving.organizationcontext.OrganizationContactsUpdated(
    orgId = _root_.scala.None,
    contacts = _root_.scala.Seq.empty,
    meta = _root_.scala.None
  )
  implicit class OrganizationContactsUpdatedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.organizationcontext.OrganizationContactsUpdated]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.organizationcontext.OrganizationContactsUpdated](_l) {
  ...
  final val CONTACTS_FIELD_NUMBER = 2
  ...
  ): _root_.com.improving.organizationcontext.OrganizationContactsUpdated = _root_.com.improving.organizationcontext.OrganizationContactsUpdated(
    orgId,
    contacts,
    meta
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationContactsUpdated])
}
