...
@SerialVersionUID(0L)
final case class OrganizationInfoUpdated(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[OrganizationInfoUpdated] {
    @transient
    ...
    def clearOrgId: OrganizationInfoUpdated = copy(orgId = _root_.scala.None)
    def withOrgId(__v: com.improving.OrganizationId): OrganizationInfoUpdated = copy(orgId = Option(__v))
    def getInfo: com.improving.organizationcontext.Info = info.getOrElse(com.improving.organizationcontext.Info.defaultInstance)
    def clearInfo: OrganizationInfoUpdated = copy(info = _root_.scala.None)
    def withInfo(__v: com.improving.organizationcontext.Info): OrganizationInfoUpdated = copy(info = Option(__v))
    ...
    def clearMeta: OrganizationInfoUpdated = copy(meta = _root_.scala.None)
    def withMeta(__v: com.improving.organizationcontext.MetaInfo): OrganizationInfoUpdated = copy(meta = Option(__v))
    ...
    def companion: com.improving.organizationcontext.OrganizationInfoUpdated.type = com.improving.organizationcontext.OrganizationInfoUpdated
    // @@protoc_insertion_point(GeneratedMessage[com.improving.organizationcontext.OrganizationInfoUpdated])
}

object OrganizationInfoUpdated extends scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfoUpdated] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfoUpdated] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.organizationcontext.OrganizationInfoUpdated = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.organizationcontext.OrganizationInfoUpdated] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = OrganizationContextDomainProto.javaDescriptor.getMessageTypes().get(18)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = OrganizationContextDomainProto.scalaDescriptor.messages(18)
  ...
  lazy val defaultInstance = com.improving.organizationcontext.OrganizationInfoUpdated(
    orgId = _root_.scala.None,
    info = _root_.scala.None,
    meta = _root_.scala.None
  )
  implicit class OrganizationInfoUpdatedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.organizationcontext.OrganizationInfoUpdated]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.organizationcontext.OrganizationInfoUpdated](_l) {
  ...
  ): _root_.com.improving.organizationcontext.OrganizationInfoUpdated = _root_.com.improving.organizationcontext.OrganizationInfoUpdated(
    orgId,
    info,
    meta
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.organizationcontext.OrganizationInfoUpdated])
}
