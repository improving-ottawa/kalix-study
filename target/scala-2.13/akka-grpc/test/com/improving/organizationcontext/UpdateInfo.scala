...
final case class UpdateInfo(
    ...
    def withName(__v: _root_.scala.Predef.String): UpdateInfo = copy(name = __v)
    def withShortName(__v: _root_.scala.Predef.String): UpdateInfo = copy(shortName = __v)
    def getAddress: com.improving.Address = address.getOrElse(com.improving.Address.defaultInstance)
    def clearAddress: UpdateInfo = copy(address = _root_.scala.None)
    def withAddress(__v: com.improving.Address): UpdateInfo = copy(address = Option(__v))
    def withIsPrivate(__v: _root_.scala.Boolean): UpdateInfo = copy(isPrivate = __v)
    def withUrl(__v: _root_.scala.Predef.String): UpdateInfo = copy(url = __v)
    def withLogo(__v: _root_.scala.Predef.String): UpdateInfo = copy(logo = __v)
    ...
    def companion: com.improving.organizationcontext.UpdateInfo.type = com.improving.organizationcontext.UpdateInfo
    // @@protoc_insertion_point(GeneratedMessage[com.improving.organizationcontext.UpdateInfo])
}

object UpdateInfo extends scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.UpdateInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.organizationcontext.UpdateInfo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.organizationcontext.UpdateInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.organizationcontext.UpdateInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = OrganizationContextDomainProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = OrganizationContextDomainProto.scalaDescriptor.messages(8)
  ...
  lazy val defaultInstance = com.improving.organizationcontext.UpdateInfo(
    name = "",
    shortName = "",
  ...
  implicit class UpdateInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.organizationcontext.UpdateInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.organizationcontext.UpdateInfo](_l) {
  ...
  def of(
    ...
    url: _root_.scala.Predef.String,
    logo: _root_.scala.Predef.String
  ): _root_.com.improving.organizationcontext.UpdateInfo = _root_.com.improving.organizationcontext.UpdateInfo(
    name,
    shortName,
    address,
    isPrivate,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.organizationcontext.UpdateInfo])
}
