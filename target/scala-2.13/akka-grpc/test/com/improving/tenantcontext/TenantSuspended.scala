...
final case class TenantSuspended(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[TenantSuspended] {
    @transient
    ...
    def clearTenantId: TenantSuspended = copy(tenantId = _root_.scala.None)
    def withTenantId(__v: com.improving.TenantId): TenantSuspended = copy(tenantId = Option(__v))
    def withName(__v: _root_.scala.Predef.String): TenantSuspended = copy(name = __v)
    def getMeta: com.improving.tenantcontext.MetaInfo = meta.getOrElse(com.improving.tenantcontext.MetaInfo.defaultInstance)
    def clearMeta: TenantSuspended = copy(meta = _root_.scala.None)
    def withMeta(__v: com.improving.tenantcontext.MetaInfo): TenantSuspended = copy(meta = Option(__v))
    ...
    def companion: com.improving.tenantcontext.TenantSuspended.type = com.improving.tenantcontext.TenantSuspended
    // @@protoc_insertion_point(GeneratedMessage[com.improving.tenantcontext.TenantSuspended])
}

object TenantSuspended extends scalapb.GeneratedMessageCompanion[com.improving.tenantcontext.TenantSuspended] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.tenantcontext.TenantSuspended] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.tenantcontext.TenantSuspended = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.tenantcontext.TenantSuspended] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TenantContextDomainProto.javaDescriptor.getMessageTypes().get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TenantContextDomainProto.scalaDescriptor.messages(10)
  ...
  lazy val defaultInstance = com.improving.tenantcontext.TenantSuspended(
    tenantId = _root_.scala.None,
    name = "",
    meta = _root_.scala.None
  )
  implicit class TenantSuspendedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.tenantcontext.TenantSuspended]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.tenantcontext.TenantSuspended](_l) {
  ...
  ): _root_.com.improving.tenantcontext.TenantSuspended = _root_.com.improving.tenantcontext.TenantSuspended(
    tenantId,
    name,
    meta
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.tenantcontext.TenantSuspended])
}
