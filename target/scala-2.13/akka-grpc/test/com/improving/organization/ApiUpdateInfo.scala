...
/** @param url
  ...
  */
@SerialVersionUID(0L)
final case class ApiUpdateInfo(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ApiUpdateInfo] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): ApiUpdateInfo = copy(name = __v)
    def withShortName(__v: _root_.scala.Predef.String): ApiUpdateInfo = copy(shortName = __v)
    ...
    def clearAddress: ApiUpdateInfo = copy(address = _root_.scala.None)
    def withAddress(__v: com.improving.organization.ApiAddress): ApiUpdateInfo = copy(address = Option(__v))
    def withIsPrivate(__v: _root_.scala.Boolean): ApiUpdateInfo = copy(isPrivate = __v)
    def withUrl(__v: _root_.scala.Predef.String): ApiUpdateInfo = copy(url = __v)
    def withLogo(__v: _root_.scala.Predef.String): ApiUpdateInfo = copy(logo = __v)
    ...
    def companion: com.improving.organization.ApiUpdateInfo.type = com.improving.organization.ApiUpdateInfo
    // @@protoc_insertion_point(GeneratedMessage[com.improving.organization.ApiUpdateInfo])
}

object ApiUpdateInfo extends scalapb.GeneratedMessageCompanion[com.improving.organization.ApiUpdateInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.improving.organization.ApiUpdateInfo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.improving.organization.ApiUpdateInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.improving.organization.ApiUpdateInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = OrganizationApiProto.javaDescriptor.getMessageTypes().get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = OrganizationApiProto.scalaDescriptor.messages(10)
  ...
  lazy val defaultInstance = com.improving.organization.ApiUpdateInfo(
    name = "",
    shortName = "",
  ...
  implicit class ApiUpdateInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.improving.organization.ApiUpdateInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.improving.organization.ApiUpdateInfo](_l) {
  ...
  def of(
    ...
    url: _root_.scala.Predef.String,
    logo: _root_.scala.Predef.String
  ): _root_.com.improving.organization.ApiUpdateInfo = _root_.com.improving.organization.ApiUpdateInfo(
    name,
    shortName,
    address,
    isPrivate,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[com.improving.organization.ApiUpdateInfo])
}
