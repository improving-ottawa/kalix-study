...
class OrganizationByMemberViewImpl(context: ViewContext)
    extends AbstractOrganizationByMemberView {
  ...
  override def processOrganizationEstablished(
    ...
    if (state != emptyState) {
      ...
      log.info(
        s"OrganizationByMemberViewImpl in processOrganizationEstablished - state already existed"
      )
      ...
      log.info(
        s"OrganizationByMemberViewImpl in processOrganizationEstablished - organizationEstablished ${organizationEstablished}"
      )
  ...
  override def processMembersAddedToOrganization(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processMembersAddedToOrganization - membersAddedToOrganization ${membersAddedToOrganization}"
    )
  ...
  override def processMembersRemovedFromOrganization(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processMembersRemovedFromOrganization - membersRemovedFromOrganization ${membersRemovedFromOrganization}"
    )
  ...
  override def processOrganizationAccountsUpdated(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOrganizationAccountsUpdated - organizationAccountsUpdated ${organizationAccountsUpdated}"
    )
  ...
  override def processOrganizationContactsUpdated(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOrganizationContactsUpdated - organizationContactsUpdated ${organizationContactsUpdated}"
    )
  ...
  override def processOrganizationInfoUpdated(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOrganizationInfoUpdated - organizationInfoUpdated ${organizationInfoUpdated}"
    )
  ...
  override def processOrganizationStatusUpdated(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOrganizationStatusUpdated - organizationStatusUpdated ${organizationStatusUpdated}"
    )
  ...
  override def processOwnersAddedToOrganization(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOwnersAddedToOrganization - ownersAddedToOrganization ${ownersAddedToOrganization}"
    )
  ...
  override def processOwnersRemovedFromOrganization(
    ...
    log.info(
      s"OrganizationByMemberViewImpl in processOwnersRemovedFromOrganization - ownersRemovedFromOrganization ${ownersRemovedFromOrganization}"
    )
