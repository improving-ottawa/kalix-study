...
class OrganizationByOwnerViewImpl(context: ViewContext)
  ...
  override def processOrganizationEstablished(
    ...
    if (state != emptyState) {
      ...
      log.info(
        s"OrganizationByOwnerViewImpl in processOrganizationEstablished - state already existed"
      )
      ...
      log.info(
        s"OrganizationByOwnerViewImpl in processOrganizationEstablished - organizationEstablished ${organizationEstablished}"
      )
  ...
  override def processMembersAddedToOrganization(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processMembersAddedToOrganization - membersAddedToOrganization ${membersAddedToOrganization}"
    )
  ...
  override def processMembersRemovedFromOrganization(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processMembersRemovedFromOrganization - membersRemovedFromOrganization ${membersRemovedFromOrganization}"
    )
  ...
  override def processOrganizationAccountsUpdated(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOrganizationAccountsUpdated - organizationAccountsUpdated ${organizationAccountsUpdated}"
    )
  ...
  override def processOrganizationContactsUpdated(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOrganizationContactsUpdated - organizationContactsUpdated ${organizationContactsUpdated}"
    )
  ...
  override def processOrganizationInfoUpdated(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOrganizationInfoUpdated - organizationInfoUpdated ${organizationInfoUpdated}"
    )
  ...
  override def processOrganizationStatusUpdated(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOrganizationStatusUpdated - organizationStatusUpdated ${organizationStatusUpdated}"
    )
  ...
  override def processOwnersAddedToOrganization(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOwnersAddedToOrganization - ownersAddedToOrganization ${ownersAddedToOrganization}"
    )
  ...
  override def processOwnersRemovedFromOrganization(
    ...
    log.info(
      s"OrganizationByOwnerViewImpl in processOwnersRemovedFromOrganization - ownersRemovedFromOrganization ${ownersRemovedFromOrganization}"
    )
